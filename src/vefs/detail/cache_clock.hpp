...
{
/**
 * Implements a dynamic clock data structure for up to ClockSize elements.
 * Requires O(ClockSize) space.
 *
 * The internal implementation uses the smallest available integer type for the
 * stored indices.
 */

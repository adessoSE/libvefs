...
namespace vefs::test
{
    class libb2_none_blake2b_crypto_provider
        : public vefs::crypto::crypto_provider
    {
    ...
    result<void> libb2_none_blake2b_crypto_provider::box_open(
    ...
    result<void>
    libb2_none_blake2b_crypto_provider::random_bytes(rw_dynblob out) const
        noexcept
    {

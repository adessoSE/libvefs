...
public:
    ...
    [[nodiscard]] inline auto try_aquire_one() noexcept
...
template <typename counter_type, counter_type LIMIT>
constexpr atomic_resource_counter<counter_type,
                                  LIMIT>::atomic_resource_counter() noexcept
...
template <typename counter_type, counter_type LIMIT>
inline auto
atomic_resource_counter<counter_type, LIMIT>::try_aquire_one() noexcept
        -> resource_acquire_result
{
...
template <typename counter_type, counter_type LIMIT>
inline auto atomic_resource_counter<counter_type, LIMIT>::release_one(
        bool deinitOnZero) noexcept -> resource_release_result
{
...
template <typename counter_type, counter_type LIMIT>
inline void
atomic_resource_counter<counter_type, LIMIT>::notify_initialized() noexcept
{
...
template <typename counter_type, counter_type LIMIT>
inline void
atomic_resource_counter<counter_type, LIMIT>::notify_cleanup_done() noexcept
{

...
namespace vefs::detail
{
    struct memory_allocation
    {
        ...
        constexpr memory_allocation(std::byte *const start, std::byte *const end) noexcept;
        constexpr memory_allocation(std::byte *const start, const std::size_t size) noexcept;

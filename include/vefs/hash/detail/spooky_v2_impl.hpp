...
public:
    ...
    //
    void Init(uint64_t seed1,  // any 64-bit value will do, including 0
    ...
    //
    void Final(uint64_t *hash1,  // out only: first 64 bits of hash value.
...
private:
    ...
    //
    static constexpr uint64_t sc_const = 0xdead'beef'dead'beefULL;

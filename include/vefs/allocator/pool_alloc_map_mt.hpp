...
{
template <std::size_t NUM_ELEMS,
          typename unit_type = fast_atomic_uint_with_bits<NUM_ELEMS>>
              ...
              NUM_ELEMS, std::numeric_limits<unit_type>::digits)>
{
    ...
    static constexpr std::size_t num_units
            = utils::div_ceil(num_elems, elems_per_unit);
...
public:
    static constexpr auto failed_reservation
...
template <std::size_t NUM_ELEMS, typename unit_type>
constexpr auto
pool_alloc_map_mt<NUM_ELEMS, unit_type>::init_alloc_map(std::size_t i) noexcept
        -> unit_t
{
...
template <std::size_t NUM_ELEMS, typename unit_type>
inline auto pool_alloc_map_mt<NUM_ELEMS, unit_type>::reserve_slot() noexcept
        -> std::size_t
{
    std::size_t pos;
    std::size_t unitIdx;
